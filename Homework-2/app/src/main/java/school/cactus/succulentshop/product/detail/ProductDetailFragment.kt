...
class ProductDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            relatedProductsRecyclerView.layoutManager = LinearLayoutManager(requireContext(),LinearLayoutManager.HORIZONTAL,false)
            relatedProductsRecyclerView.adapter = adapter
            relatedProductsRecyclerView.addItemDecoration(ProductDetailDecoration())
            adapter.submitList((store.products.minus(product)).take(4))
